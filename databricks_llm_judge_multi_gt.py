...
# MAGIC %md
# MAGIC # 🤖 LLM Judge Evaluation System - Multi Ground Truth Support
# MAGIC 
...
# MAGIC 
# MAGIC ### 📊 Enhanced Ground Truth Support:
# MAGIC - **Per-metric ground truth files**: Each metric can have its own ground truth file
# MAGIC - **🆕 Multiple files per metric**: Support comma/semicolon separated filenames
...
# MAGIC - **🆕 Data combination**: Multiple ground truth sources are combined intelligently
# MAGIC 
# MAGIC ### 📁 File Upload Instructions:
# MAGIC 1. **Upload evaluation data**: `evaluation_data.csv` to your workspace
# MAGIC 2. **Upload metrics config**: `sample_metrics_config_multi_gt.csv` to your workspace  
# MAGIC 3. **Upload ground truth files**: Upload all ground truth CSV files to workspace
# MAGIC 4. **Update filenames**: Modify the widget values below to match your files
# MAGIC 
# MAGIC ### 🆕 Multi Ground Truth Examples:
# MAGIC - **Single file**: `correct_answer.csv`
# MAGIC - **Multiple files (comma)**: `correct_answer.csv,accuracy_expert1.csv,accuracy_expert2.csv`
# MAGIC - **Multiple files (semicolon)**: `helpful_answer.csv;helpfulness_rating1.csv;helpfulness_rating2.csv`
...
print("✅ Databricks LLM system loaded with multi ground truth support and auto-discovery")
