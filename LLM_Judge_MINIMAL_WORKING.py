...
# MAGIC %md
# MAGIC # LLM-as-a-Judge: MINIMAL WORKING VERSION
# MAGIC 
# MAGIC **Simple, tested version - add/edit/delete metrics**
...
# MAGIC %md
# MAGIC ## Cell 2.5: Metrics Editor - SIMPLE VERSION
...
if action == "view":
    print("\n?? VIEW MODE")
    # Remove add widgets if they exist
...
if action == "add":
    ...
    if save_btn == "yes" and m_name:
        ...
        dbutils.widgets.text("m_name", "", "1. Name")
        dbutils.widgets.remove("m_desc")
        dbutils.widgets.text("m_desc", "", "2. Description")
        dbutils.widgets.remove("m_rubric")
        dbutils.widgets.text("m_rubric", "", "3. Grading Rubric")
        dbutils.widgets.remove("m_threshold")
        dbutils.widgets.text("m_threshold", "", "4. Threshold")
        ...
        print(f"\n?? Fill form and set Save='yes' to add")
...
print("\n?? INSTRUCTIONS:")
print("  1. Select Action='add'")
print("  2. Fill in: Name, Description, Rubric, Threshold")
print("  3. Set Save='yes'")
print("  4. Re-run this cell (Shift+Enter)")
print("  5. Switch to Action='view' to see updated list")
